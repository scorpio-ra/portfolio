...
function startdraw(id) {
    ...
    canv1.onmousedown = function(e) {
        ...
        x = e.clientX + (html && html.scrollLeft || body && body.scrollLeft || 0) - (html.clientLeft || 0)-coord.left;
        y = e.clientY + (html && html.scrollTop || body && body.scrollTop || 0) - (html.clientTop || 0)-coord.top;
